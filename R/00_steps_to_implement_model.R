...
# 2. Make a function that computes the implied model structures (12_rnm_implied.R)
# 3. Make a preperation function (12_rnm_prepare.R)
...
# 7. Edit generalFit_gradient.R to link to new derivative function
