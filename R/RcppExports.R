...
d_phi_theta_meta_var1_group_cpp <- function(grouplist) {
    .Call(`_psychonetrics_d_phi_theta_meta_var1_group_cpp`, grouplist)
}

d_phi_theta_meta_var1_cpp <- function(prep) {
    .Call(`_psychonetrics_d_phi_theta_meta_var1_cpp`, prep)
}

implied_meta_var1_cpp <- function(model, all = FALSE) {
    .Call(`_psychonetrics_implied_meta_var1_cpp`, model, all)
}

prepare_meta_var1_cpp <- function(x, model) {
    .Call(`_psychonetrics_prepare_meta_var1_cpp`, x, model)
}

d_phi_theta_panelvar_group_cpp <- function(grouplist) {
    .Call(`_psychonetrics_d_phi_theta_panelvar_group_cpp`, grouplist)
}

d_phi_theta_panelvar_cpp <- function(prep) {
    .Call(`_psychonetrics_d_phi_theta_panelvar_cpp`, prep)
}

implied_panelvar_cpp <- function(model, all = FALSE) {
    .Call(`_psychonetrics_implied_panelvar_cpp`, model, all)
}

prepare_panelvar_cpp <- function(x, model) {
    .Call(`_psychonetrics_prepare_panelvar_cpp`, x, model)
}

d_phi_theta_ml_varcov_group_cpp <- function(grouplist) {
...
implied_ml_varcov_cpp <- function(model, all = FALSE) {
    .Call(`_psychonetrics_implied_ml_varcov_cpp`, model, all)
}

prepare_ml_varcov_cpp <- function(x, model) {
    .Call(`_psychonetrics_prepare_ml_varcov_cpp`, x, model)
}
